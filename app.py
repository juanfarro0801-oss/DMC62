...
if seccion == "Home":
    ...
    tasa_anual_pct = st.number_input("Ingrese la tasa de interés anual (%)", min_value=12.0, value=0.0, step=0.5)
    plazo_meses = st.number_input("Ingrese el plazo en meses", min_value=1, value=12,0 step=1)
